...
const testFile = path.join(__dirname, 'artifacts', 'bigip.conf');
...
describe('explode devCloud ucs tests', async function() {
    ...
    it(`list apps`, async function() {
        ...
        //   ];
          const expected = [
            "/Common/sni-routing-1a",
            "/Common/sni-routing-1b",
            "/Common/www.myaspirevisa.com",
          ];  
...
=======
    it(`get app config by name`, async function() {
        ...
        const appConfig = app[0].config;
>>>>>>> 2325a3f03247cfccb659e70a0ddb662094ec987b
